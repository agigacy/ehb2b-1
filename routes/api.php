...
Route::middleware('auth:sanctum')->apiResource('/tour-groups', 'App\Http\Controllers\Api\TourGroupController');
Route::middleware('auth:sanctum')->get('/tour-groups/by-country/{countryId}', 'App\Http\Controllers\Api\TourGroupController@getByCountry');
